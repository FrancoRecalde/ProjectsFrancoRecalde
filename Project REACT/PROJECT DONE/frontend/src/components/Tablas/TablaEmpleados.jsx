...
import { COLUMNS_EMPLEADOS } from "../data/columns.jsx";
...
export const TablaEmpleados = () => {
    ...
    const COLUMNS = useMemo(() => COLUMNS_EMPLEADOS, []);
    const {
        register,
        handleSubmit,
        formState: { errors },
    ...
    const filterSubmit = async (data) => {
        try {
            empleadosServices
                .getEmpleadosFiltradas(data)
                .then((data) => setData(data));
        } catch (error) {
            console.error("Error fetching filtered empleados:", error);
        }
    };
    ...
    useEffect(() => {
        empleadosServices.getEmpleados().then((response) => setData(response));
        getData();
    }, []);
    ...
    const onSubmit = async (data) => {
        console.log(data);
        try {
            await empleadosServices.updateEmpleado(data);
            empleadosServices.getEmpleados().then((data) => setData(data));
            setAccordion(-1);
        } catch (e) {
    ...
    const eliminar = async (empleadoId) => {
        try {
            await empleadosServices.deleteEmpleado(empleadoId);
            empleadosServices.getEmpleados().then((data) => setData(data));
            setModal(false);
        } catch (e) {
                                                    ...
                                                    <div className="form__group field">
                                                        <input
                                                            ...
                                                            {...register(
                                                                ...
                                                                {
                                                                    required:
                                                                        "ID Usuario es requerido",
                                                                    pattern: {
                                                                        value: /^\d+$/,
                                                                        message:
                                                                            "ID Usuario debe ser un número",
                                                                    },
                                                                }
                                                            )}
                                                        ></input>
                                                            ...
                                                            {...register(
                                                                "salario",
                                                                {
                                                                    ...
                                                                    min: {
                                                                        value: 0,
                                                                        message:
                                                                            "Salario debe ser un número positivo",
                                                                    },
                                                                }
                                                            )}
                                                        ></input>
                                                    ...
                                                    <div className="form__group field">
                                                        <input
                                                            ...
                                                            {...register(
                                                                ...
                                                                {
                                                                    required:
                                                                        "Comision es requerida",
                                                                    min: {
                                                                        value: 0,
                                                                        message:
                                                                            "Comision debe ser un número positivo",
                                                                    },
                                                                    max: {
                                                                        value: 100,
                                                                        message:
                                                                            "Comision no puede ser mayor a 100",
                                                                    },
                                                                }
                                                            )}
                                                        ></input>
